    ...
    resources: {
      en: {
        translation: {
          ...
          hero: {
            1: 'Pub Quiz is an intellectual team game, lasting one and a half to two hours of lively communication and emotions.',
            2: 'But Quiz in Finike was something bigger...',
            3: '',
            4: '',
            finike: 'Finike',
            chat: 'Our chat',
      ...
      ru: {
        translation: {
          ...
          hero: {
            1: 'Квиз - интеллектуальная командная игра, полтора-два часа бурного общения и эмоций',
            2: 'Но квиз в Финике - нечто большее...',
            3: '',
            4: '',
            finike: 'Финике',
            chat: 'Наш чат',
